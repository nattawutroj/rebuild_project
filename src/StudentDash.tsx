...
export default function Dashboard() {
    ...
    const { iseditProfileModal, isopenPasswordModal, setIseditProfileModal, setIsopenPasswordModal } = useAuth();
    ...
    const [selectedMajor, setSelectedMajor] = React.useState<any>(profile.major_code);
    const [selectedTitle, setSelectedTitle] = React.useState<any>(profile.id_name_title);
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    defaultValue={profile.id_name_title}
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    defaultValue={profile.major_code}
                                    onChange={handleMajorChange}
                                >
                                    {majorCode.map((option: any, index: any) => (
                                        <MenuItem key={index} value={option.value}>{option.label}</MenuItem>
                                    ))}
                                </TextField>
                            </Grid>
