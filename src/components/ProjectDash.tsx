...
export default function ProjectDash() {
    ...
    const [openJoin, setOpenJoin] = React.useState<any>(false);
    const styleModal = {
        position: 'absolute',
        top: '50%',
        left: '50%',
    ...
    const [searchJoinField, setSearchJoinField] = React.useState<any>('');

    const handleSearchJoinField = (e: any) => {
        setSearchJoinField(e.target.value);
    }

    const [submitJoinDisabled, setSubmitJoinDisabled] = React.useState<any>(true);

    const [accDetail, setAccDetail] = React.useState<any>(false);
    const [joinDetail, setJoinDetail] = React.useState<any>();
    ...
    const [addProjectBtn, setAddProjectBtn] = React.useState<any>(true);
    ...
    return (
        <ThemeProvider theme={theme}>
            <React.Fragment>
                ...
                >
                    <Box sx={{ ...styleModal, width: 400 }}>
                        <p className='w-full text-2xl'>สร้างโปรเจคของคุณ</p>
                ...
                >
                    <Box sx={{ ...styleModal, width: 400 }}>
                        ...
                        <Button
                            ...
                            sx={{ mt: 3, mb: 2 }}
                        >
                            {submitJoinDisabled ? 'Join' : accDetail ? 'Join' : 'Joined'}
                        </Button>
                    </Box>
                </Modal>
            </React.Fragment>
